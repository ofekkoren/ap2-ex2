...
-   - Go to the *ChatApplciation* folder, open in visual studio the solution on the project. In the solution explorer of vs right click on the solution,click on properties,
